...
| Malicious transcript path | Absolute regular-file check, symlink skip, race-resistant opens on Unix and Windows, bounded reads, model revalidated before use | Transcript resolver tests | Model stays `unknown` |
