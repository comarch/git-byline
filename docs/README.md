...
| Question | Document |
| --- | --- |
| Why does line-level provenance matter? | [Why git-byline](WHY_GIT_BYLINE.md) |
| Which systems and agents are supported? | [Compatibility](COMPATIBILITY.md) |
| What data stays on disk? | [Security model](SECURITY_MODEL.md) |
...
| Respond to a security event | [Incident response](INCIDENT_RESPONSE.md) |
| Reproduce repository controls | [Repository settings](REPOSITORY_SETTINGS.md) |
